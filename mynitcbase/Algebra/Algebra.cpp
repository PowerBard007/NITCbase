...
{
    //cannot insert into system catalogs
    if(strcmp(relName,"RELATIONCAT")==0||strcmp(relName,"ATTRIBUTECAT")==0)
    {
        return E_NOTPERMITTED;
    }

    // get the relation's rel-id if open from tableMetaInfo in cache
    ...
    // check if relCatEntry.numAttrs is equal to numberOfAttributes in relation
